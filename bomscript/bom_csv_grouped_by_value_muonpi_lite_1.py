...
out.writerow(['Ref', 'Qnty', 'Value', 'Footprint', 'Supplier', 'OriginalType', 'Preplaces By JLC', 'JLC Type', 'JLC Part Number'])
...
for group in grouped:
    ...
    out.writerow([refs, len(group),
        ...
        fromNetlistText( c.getField("OriginalType") ),
        fromNetlistText( c.getField("JLC_placed_by") ),
        fromNetlistText( c.getField("JLCType") ),
        fromNetlistText( c.getField("JLCplace") )])
